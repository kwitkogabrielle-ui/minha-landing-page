    ...
    <section id="sobre">
      <div className="sobre-grid">
        <div className="sobre-image">
          ...
          <a href={PERFIL_GOOGLE} target="_blank" className="sobre-badge">
            <strong>4.9★</strong>
        ...
        <div className="sobre-text">
          ...
          <p>A Dra. Gabrielle Kwitko é enfermeira esteta (COREN 652.755) especialista em procedimentos injetáveis e harmonização facial e corporal, com clínica em Florianópolis, SC.</p>
