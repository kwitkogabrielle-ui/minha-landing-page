...
const facial = [
  { icon: "💉", title: "Toxina Botulínica",                    desc: "Suavização de rugas de expressão na testa, ao redor dos olhos e pescoço com resultado natural." },
  ...
  { icon: "👃", title: "Rinomodelação",                        desc: "Correção estética do nariz sem cirurgia, com resultados imediatos e seguros." },
  { icon: "🌟", title: "Bioestimulador",                       desc: "Estimulação natural de colágeno para rejuvenescimento profundo e progressivo." },
];

const corporal = [
  { icon: "🍑", title: "Harmonização Glútea",   desc: "Modelagem glútea não cirúrgica com volume, firmeza e forma definida." },
  { icon: "🌸", title: "Harmonização de Mamas", desc: "Bioestimuladores e preenchedores para firmeza e contorno mamário sem cirurgia." },
  { icon: "💫", title: "Escleroterapia",         desc: "Tratamento de varizes e vasinhos com segurança e eficácia comprovada." },
];
